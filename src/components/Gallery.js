    ...
    <>
        ...
        <div className="gallery">
          <Link to='/seaside'>
            ...
            <div className='title'>1. Seaside Heights Boardwalk</div>
        ...
        <div className="gallery">
          <Link to='/six'>
            ...
            <div className='title'>2. Six Flags</div>
        ...
        <div className="gallery">
          ...
          <img style={{ height: "200px" }} src={require('../images/Atlantic/AtlanticGallery1.jpg')} />
            <div className='title'>3. Atlantic City</div>
        ...
        <div className="gallery">
          ...
          <img style={{ height: "200px" }} src={require('../images/PNC/PncGallery3.jpeg')} />
            <div className='title'>4. PNC Bank Art Center</div>
        ...
        <div className="gallery">
          <Link to='/prudential'>
            ...
            <div className='title'>5. Prudential Center</div>
        ...
        <div className="gallery">
          <Link to='/park'>
            ...
            <div className='title'>6. Liberty State Park</div>
        ...
        <div className="gallery">
          <Link to='/liberty'>
            ...
            <div className='title'>7. Liberty Science Center</div>
        ...
        <div className="gallery">
          <Link to='/gardens'>
            ...
            <div className='title'>8. Botanical Gardens</div>
        ...
        <div className="gallery">
          <Link to='/mall'>
            ...
            <div className='title'>9. American Dream Mall</div>
        ...
        <div className="gallery">
          <Link to='/princeton'>
            <img style={{ height: "200px" }} src={require('../images/Princeton/PrincetonGallery3.jpg')} />
            <div className='title'>10. Princeton</div>
